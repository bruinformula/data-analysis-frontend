...
export default function Home() {
  ...
  const onLogSelect = (collectionName, name) => {
    ...
    fetch(
      `${SERVER_ADDRESS}/api/plot?collection=${collectionName}&name=${name}&plot=${plotData}&parser=mk8-data-parser`,
      {
        method: "GET",
      }
    )
  ...
  const handleFileUpload = (event) => {
    ...
    reader.onload = function () {
      ...
      if (superFolder.includes("/")) return;
          ...
          <div className="row" style={{ minHeight: "100vh" }}>
            ...
            <div className="col" style={{ maxWidth: "20vh" }}>
              ...
              <FormControl sx={{ m: 1, minWidth: 195 }}>
                ...
                >
                  <MenuItem value={"mk-8-data-parser"}>
                    mk-8-data-parser
                  </MenuItem>
                </Select>
              </FormControl>
